		...
		<section className="py-20 px-4">
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					<h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Let&apos;s Build Something Amazing</h2>
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:ms.mirnasalem@gmail.com"
						...
						<a
							href="/resume.pdf"
							target="_blank"
							className="px-8 py-3 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded-lg font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors inline-flex items-center justify-center gap-2"
						>
							<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
								<path
									fillRule="evenodd"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/mirna-salem"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/mirnasalem"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg"
						>
						...
						{/* Twitter/X link commented out - no social media for now
						<a
